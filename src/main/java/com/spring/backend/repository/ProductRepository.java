...
public interface ProductRepository
  ...
  Page<ProductEntity> findByCategoryIdAndStatusAndIdNotAndIsActivedTrueAndQuantityGreaterThan(
      Long categoryId, ProductStatus status, Long id, int quantity, Pageable pageable);
